...
export const AuthLayout: React.FC<IAuthLayout> = ({
  ...
  return (
    <div className="w-full min-h-[100vh] lg:h-[100vh] border-[5px] border-blackText flex p-3 lg:p-10 gap-10">
      ...
      <div className="w-full lg:basis-1/2 flex flex-col items-center gap-7">
        <img src={CowryLogo} alt="cowry" className="h-20 w-20" />
        <div className="grid gap-2 w-full px-2 md:px-20 text-center overflow-y-scroll">
